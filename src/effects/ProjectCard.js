    ...
    >
      <div>
        ...
        <ul className="text-[10px] tech-stack">
          ...
          <a href={Data.liveLink} target='_blank' rel='noreferrer' className='button cursor-pointer'>Live Demo</a>
          <a href={Data.githubLink} target='_blank' rel='noreferrer' className='button button-github cursor-pointer'>GitHub</a>
        </p>
          </div>
